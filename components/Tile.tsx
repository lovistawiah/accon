...
const Tile = ({ img }: { img: string }) => {
  return (
    <section className="flex gap-[1px] flex-col w-[180px] h-fit pb-[5px] items-center rounded border-[0.8px] border-solid border-slate-300">
      <Image
        src={img}
        alt="house"
        width={180}
      ...
      <section className="flex flex-col items-start rounded-b-[5px] pl-[3px]">
        {/*Price  */}
        <section className="flex self-stretch text-[16.5px] leading-normal font-[600] text-sky-950 ">
          GHC 700
          <span className="text-[16px] font-[400] pl-[2px]">per night</span>
        </section>
        {/* apartment */}
        <section className="flex flex-wrap text-slate-950 tex-[16px] leading-tight">
